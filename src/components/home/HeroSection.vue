...
const mailHref = `mailto:${clinic.email}?subject=${encodeURIComponent('Mill Town Coffee — hello from your demo site')}`
const facts = [
  { label: 'Hours', value: clinic.hours[0].time },
  { label: 'Good to know', value: `${clinic.insurance.length} highlights` },
  { label: 'Drive-thru', value: `${clinic.stats[2].value} windows` },
]
      ...
      <div ref="aside" class="hero__grid">
        <div class="hero__intro">
          ...
          <div data-intro class="hero__actions">
            <a class="btn btn--solid" :href="mailHref">
    ...
    <div class="hero__mediaWrap">
      <div ref="frame" class="hero__frame">
        <img
          ref="photo"
          class="hero__photo"
          src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=2000&h=1125&fit=crop&auto=format"
