...
const quickLinks = [
  ...
  { href: '#especialidades', label: 'Menu' },
  { href: '#equipe', label: 'Team' },
  { href: '#depoimentos', label: 'Reviews' },
  { href: '#contato', label: 'Visit' },
]
...
<template>
  <footer ref="footer" class="footer theme-dark">
    <div class="container">
      <div class="footer__grid">
        ...
        <div data-anim class="footer__col">
          <p class="mono footer__label">Visit</p>
          <ul>
            <li>
              <a :href="clinic.instagramUrl || clinic.social.instagram" target="_blank" rel="noopener noreferrer">{{ clinic.phone }}</a>
            </li>
            <li>
    ...
    <div class="container footer__bottom">
      <p class="mono">
        {{ clinic.legal.razaoSocial }} · Demo personalized for outreach
        {{ clinic.legal.cnes }}
      </p>
      <p class="mono">© {{ year }} — All rights reserved · demo</p>
    </div>
  </footer>
</template>
...
.footer__logotype {
  ...
  text-align: center;
  color: transparent;
  -webkit-text-stroke: 1px rgba(242, 239, 232, 0.28);
