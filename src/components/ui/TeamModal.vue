...
function contactHref(member) {
  const subject = encodeURIComponent(`Mill Town Coffee — question about ${member.name}`)
  const body = encodeURIComponent(`Hi! Found your demo site — can I ask about ${member.name} / ${member.role}?`)
